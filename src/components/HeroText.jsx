  ...
  return (
    <div className='z-10 mt-20 text-center md:mt-40 md:text-left rounded-3xl bg-clip-text'>
        ...
        <div className='flex-col hidden md:flex c-space'>
            ...
            initial="hidden"
            animate="visible"
            transition={{delay:1}}>Hi I'm Sayandip Saha</motion.h1>
            <div className='flex flex-col item-start'>
                <motion.p className='text-5xl font-medium text-neutral-500'
                variants={variants}
                initial="hidden"
                animate="visible"
            ...
            >A developer <br /> dedicated to Crafting</motion.p>
                ...
                >
                    Web and Machine Learning solutions
                </motion.p>
            </div>
        </div>
        {/* Mobile view */}
